...
[项目官网](https://lincodex.cn/index.php/archives/59/) · [下载最新版](https://github.com/zhu-hailin/dji4g-gen1-panel/releases/latest) · [使用说明](docs/使用说明.txt) · [更新记录](docs/RELEASE_NOTES_0.1.6.md) · [安全说明](SECURITY.md)
...
4. 若模块检查通过但浏览器或代理软件不能联网，打开“诊断 → 电脑网络与代理”。
