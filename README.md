...
[项目官网](https://lincodex.cn/index.php/archives/59/) · [下载最新版](https://github.com/zhu-hailin/dji4g-gen1-panel/releases/latest) · [使用说明](docs/使用说明.txt) · [更新记录](docs/RELEASE_NOTES_0.1.7.md) · [安全说明](SECURITY.md)
...
![模块网络检查（模拟数据，不代表实机验收）](docs/screenshots/module-network-check.png)
